...
System.register(['aurelia-templating'], function (_export, _context) {
  ...
  var viewEngineHooks, ViewFactory, View, _dec, _class, CleanBindingCommands;
  ...
  return {
    setters: [function (_aureliaTemplating) {
      viewEngineHooks = _aureliaTemplating.viewEngineHooks;
      ViewFactory = _aureliaTemplating.ViewFactory;
      View = _aureliaTemplating.View;
    }],
    execute: function () {
      _export('CleanBindingCommands', CleanBindingCommands = (_dec = viewEngineHooks(), _dec(_class = function () {
      ...
      _export('CleanBindingCommands', CleanBindingCommands);
    }
  };
});